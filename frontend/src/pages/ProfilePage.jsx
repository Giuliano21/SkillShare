...
export const ProfilePage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!window.confirm("Confermi il salvataggio delle modifiche al profilo?"))
      return;
    setError("");
    setMessage("");
    try {
  ...
  if (!profile)
    return (
      <div className="content-page">
        <p className="empty-state">{error || "Caricamento profilo..."}</p>
      </div>
    );
    ...
    <div className="content-page narrow-page">
      ...
      <form className="panel profile-form" onSubmit={handleSubmit}>
        ...
        {isTutor && (
          <div className="tutor-fields">
            <div className="form-divider">
              <h2>Profilo tutor</h2>
              <p>Queste informazioni compaiono nella ricerca.</p>
            </div>
            <label>
              ...
              <input
                ...
                onChange={(event) =>
                  setTutorForm({ ...tutorForm, subjects: event.target.value })
                }
              />
            </label>
            <div className="form-grid">
            ...
            <label>
              ...
              <textarea
                value={tutorForm.bio}
                onChange={(event) =>
                  setTutorForm({ ...tutorForm, bio: event.target.value })
                }
              />
            </label>
          </div>
        ...
        <div className="form-divider">
          ...
          <p>Lascia vuoto se non vuoi modificare le credenziali.</p>
        </div>
        <div className="form-grid">
          <label>
            Password attuale
