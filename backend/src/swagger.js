...
const swaggerDefinition = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "Documentazione completa delle API di SkillShare per autenticazione, tutor, prenotazioni e recensioni.",
  },
  servers: [
    {
  ...
  tags: [
    ...
    {
      name: "Chats",
      description: "Chat privata real-time tra tutor e studente",
    },
  ],
  components: {
    securitySchemes: {
    ...
    schemas: {
      ...
      Review: {
        ...
        properties: {
          ...
          comment: {
            type: "string",
            example: "Ottimo tutor, molto disponibile",
          },
        },
      },
      Conversation: {
        ...
        properties: {
          ...
          participantsKey: {
            ...
            example: "64d1f4c9e1b44a0012345678:64d1f4c9e1b44a0012345690",
            description:
              "Chiave unica normalizzata della coppia di partecipanti",
          },
          createdAt: { type: "string", format: "date-time" },
          updatedAt: { type: "string", format: "date-time" },
        },
      ...
      Message: {
        ...
        properties: {
          ...
          conversationId: {
            type: "string",
            example: "64d1f4c9e1b44a0012345683",
          },
      ...
      SendMessageRequest: {
        ...
        properties: {
          text: {
            ...
            minLength: 1,
            maxLength: 1000,
            example: "Ciao, quando possiamo iniziare?",
          },
        },
      },
      MessagesResponse: {
  ...
  paths: {
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    message: {
                      type: "string",
                      example: "Il server è correttamente in funzione",
                    },
                  },
                },
              },
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    message: {
                      type: "string",
                      example: "Profilo utente cancellato con successo",
                    },
                  },
                },
              },
        ...
        parameters: [
          {
            ...
            in: "query",
            schema: { type: "string" },
            description: "Materia da ricercare",
          },
          {
            name: "minPrice",
            in: "query",
            schema: { type: "number" },
            description: "Prezzo minimo orario",
          },
          {
            name: "maxPrice",
            in: "query",
            schema: { type: "number" },
            description: "Prezzo massimo orario",
          },
          {
            name: "minRating",
            in: "query",
          ...
          },
          {
            name: "lessonMode",
            in: "query",
            schema: { type: "string", enum: ["remote", "presence"] },
            description: "Modalità di lezione",
          },
          {
            name: "sort",
            in: "query",
          ...
          200: {
            ...
            content: {
              "application/json": {
                schema: {
                  type: "object",
                  properties: { tutor: { $ref: "#/components/schemas/Tutor" } },
                },
              },
            },
          },
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  tutorId: {
                    type: "string",
                    example: "64d1f4c9e1b44a0012345679",
                  },
                  slotId: {
                    type: "string",
                    example: "64d1f4c9e1b44a0012345680",
                  },
                  subject: { type: "string", example: "Matematica" },
                },
              },
                ...
                schema: {
                  ...
                  properties: {
                    conversations: {
                      type: "array",
                      items: {
                        $ref: "#/components/schemas/ConversationWithUsers",
                      },
                    },
                  },
                },
    ...
    "/api/v1/chats/conversations/with/{peerUserId}": {
      post: {
        ...
        description:
          "Apre una chat privata 1:1 tra l'utente autenticato e il peer specificato. Richiede almeno una prenotazione accettata tra tutor e studente. La conversazione viene creata una sola volta per coppia di utenti e rimane disponibile anche se lo stato della prenotazione cambia.",
        security: [{ bearerAuth: [] }],
        parameters: [
          {
            name: "peerUserId",
        ...
        responses: {
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    message: {
                      type: "string",
                      example: "Conversazione disponibile.",
                    },
          ...
          403: {
            description:
              "Chat non consentita: serve almeno una prenotazione accettata tra tutor e studente",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/Error" },
              },
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            description:
              "Numero di messaggi per pagina (default: 30, max: 100)",
          },
        ],
        responses: {
          200: {
