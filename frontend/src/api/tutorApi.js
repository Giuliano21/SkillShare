...
export const updateMyTutor = (data) =>
  http("/tutors/me", { method: "PUT", body: data });

export const getTutorAvailability = (id) => http(`/tutors/${id}/availability`);

export const addtutorAvailability = (id, data) =>
  http(`/tutors/${id}/availability`, {
    method: "POST",
    body: data,
  });

export const updateTutorAvailability = (id, data) =>
  http(`/tutors/${id}/availability`, {
    method: "PUT",
    body: data,
  });
...
export const deleteTutorAvailability = (id) =>
  http(`/tutors/availability/${id}`, { method: "DELETE" });
